...
def main():
    A1_df=pd.read_csv("ADARediting/A1all1.xls", sep="\t")
    A2_df=pd.read_csv("ADARediting/A2all2.xls", sep="\t")
    A3_df=pd.read_csv("ADARediting/A3all3.xls", sep="\t")
    A4_df = pd.read_csv("ADARediting/A4all4.xls", sep="\t")
    lst1=get_list(A1_df)
    lst2=get_list(A2_df)
    lst3=get_list(A3_df)
    lst4=get_list(A4_df)
    draw_venn3(lst1,lst2,lst3, lst4)
